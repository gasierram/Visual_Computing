 ...
 * la variable representation declarada en Boid (line 16); // 0 is Face vertex , 1 is vertex vertex
 * la variable renderMode declarada en Boid (line 17) ; // 0 is inmediate, 1 is retained.